function product4h(grid, row, col) {
  return (
    grid[row][col] *
    grid[row][col + 1] *
    grid[row][col + 2] *
...
function product4v(grid, row, col) {
    return (
        grid[row][col] *
        grid[row + 1][col] *
        grid[row + 2][col] *
...
function product4d(grid, row, col) {
    return (
        grid[row][col] *
        grid[row + 1][col + 1] *
        grid[row + 2][col + 2] *
...
function product4dr(grid, row, col) {
    return (
        grid[row][col] *
        grid[row - 1][col + 1] *
        grid[row - 2][col + 2] *
...
function cal(grid) {
  ...
  for (let col = 0; col < SIZE - 4; col++) {
    for (let row = 0; row < SIZE; row++) {
      const p = product4h(grid, row, col);
      if (p > max) {
        max = p;
      }
    }
  ...
  for (let col = 0; col < SIZE; col++) {
    for (let row = 0; row < SIZE - 4; row++) {
      const p = product4v(grid, row, col);
      if (p > max) {
        max = p;
      }
    }
  ...
  for (let col = 0; col < SIZE - 4; col++) {
    for (let row = 0; row < SIZE - 4; row++) {
      const p = product4d(grid, row, col);
      if (p > max) {
        max = p;
      }
    }
  ...
  for (let col = 0; col < SIZE - 4; col++) {
    for (let row = 3; row < SIZE; row++) {
      const p = product4dr(grid, row, col);
      if (p > max) {
        max = p;
      }
    }
